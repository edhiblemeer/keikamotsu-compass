"""tokyo-koto OG image generator.
hero_v3.jpg (1536x1024) を 1200x630 に crop (上から0.30寄せ・横center) し、
右側に dark gradient + "KOTO" (white serif) + "KEIKAMOTSU RANKING 2026" (sans) を overlay。
adachi/kita/itabashi og.jpg と同トーン。 raw も og_raw.jpg として保存。
テキストは gpt-image-1 で焼かず PIL ImageDraw で載せる (memory: feedback_og_image_text_overlay・下端切れ防止)。
"""
from PIL import Image, ImageDraw, ImageFont

SRC = "public/images/area/tokyo-koto/hero_v3.jpg"
OUT = "public/images/area/tokyo-koto/og.jpg"
OUT_RAW = "public/images/area/tokyo-koto/og_raw.jpg"

OG_W, OG_H = 1200, 630

SERIF = "C:/Windows/Fonts/timesbd.ttf"  # Times New Roman Bold (serif, ADACHI/KITA と同系)
...
def main() -> None:
    ...
    # "KOTO" は "KITA" と同字数 → KITA と同じ title size を使う
    title_font = ImageFont.truetype(SERIF, 132)
