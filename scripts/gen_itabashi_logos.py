"""板橋区記事の新規競合6社のプレースホルダーロゴ生成。
既存 lib-works.png 等と同スタイル: 1536x1024・#FAFAFA背景・黒line-art配送トラック+社名(黒太字sans)。
PIL で deterministic 生成 (gpt-image-1不要)。 logiquest/makeone/bst は既存再利用。
"""
