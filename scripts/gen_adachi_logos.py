"""足立区記事の新規競合プレースホルダーロゴ生成。
既存 sg.png / k-vancrew.png / neltec.png 等と同スタイル: 1536x1024・#FAFAFA背景・黒line-art配送トラック+社名(黒太字sans)。
PIL で deterministic 生成 (gpt-image-1不要)。
bst/k-vancrew/sg/neltec/tokyo-keikamotsu/logiquest/realize-itabashi/makeone は既存再利用。
新規生成のみ: towa-express
"""
